...
# read files
omicsFile<-read.table(paste(tumorType, "_", dataType, ".txt", sep=""), stringsAsFactors=F, sep=",")
omicsNameFile<-read.table(paste(tumorType, "_", dataType, "_ids.txt", sep=""), stringsAsFactors=F, sep="")
...
clinicalFile<-read.table(paste("nationwidechildrens.org_clinical_patient_", tumorType, ".txt", sep=""), stringsAsFactors = F, sep="\t", quote="")
