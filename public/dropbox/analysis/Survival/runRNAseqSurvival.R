...
# training, test set 1: 1 to 345, 346 to 494
#trainingSet<-1:345
#testSet<-346:length(survivedDays)
# training, test set 2: random 345, 149
set.seed(30)
trainingSet<-sample(length(survivedDays), 345, replace=F)
