...
for (classifier in 1:numClassifiers){
  write(paste("Classifier",classifier,sep=""), "chiAUCs321R1.csv", append=T)
  write.table(AUCs[,,classifier], "chiAUCs321R1.csv", append=T, quote=F, row.names=F, col.names=F, sep=",")
}
