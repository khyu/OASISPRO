...
colnames(proteomics)<-t(proteinNames[1,])
...
write.table(AUCs, "outputAUC.csv", quote=F, row.names=F, col.names=F)
#
ggplot() + 
...
png(filename="decisionTree.png", width=1000, height=500)
